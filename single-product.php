				...
				<div class=" product">
					...
					<div class="row">
								...
								<ul class="slides">
									<li data-thumb="img/temp-images/hoodie_7_front-140x140.jpg">
										<a href="img/temp-images/hoodie_7_front.jpg" data-imagelightbox="gallery" class="hoodie_7_front">
											<img style="width: 470px; height: 470px" src="/admin/img/products/<?php echo $product->p_image;?>" class="attachment-shop_single" alt="image">
										</a>
									</li>
						...
						<div class="col-sm-6 col-md-7 product-review entry-summary">
							...
							<h1 class="product_title"><?php echo $product->p_name;?></h1>
							...
							<div>
								<p class="price"><del><span class="amount">$60.00</span></del>
									<ins><span class="amount">$<?php echo $product->p_price;?></span></ins></p>
							</div>
							...
							<form class="variations_form cart" method="post">
								<div class="quantity">
                                   ...
                                   <br>
								<a style="width: 200px" class="btn btn-secondary btn-block" href="payment.php">Buy</a>
