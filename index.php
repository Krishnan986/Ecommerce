									...
									<div class="tp-banner tp-banner0">
										<ul>
											...
											<li data-link="#" data-target="_self" data-transition="flyin" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
												<!-- MAIN IMAGE --><img style="width: 869px; height:549px" src="/admin/img/products/DSCN8185.JPG" alt="slidebg1" data-lazyload="/admin/img/products/DSCN8185.JPG" data-bgposition="left center" data-kenburns="off" data-duration="14000" data-ease="Linear.easeNone" data-bgpositionend="right center" />
												<!-- LAYER NR. 1 -->
		...
		<div class="container">
			...
			<div id="shop-all" class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-3 product-item filter-best">
					<div style="width: 250px; height:350px" class="product-img">
						<img style="width: 250px; height:350px" src="/admin/img/products/<?php echo $product->p_image;?>" alt="product">
						<div class="product-hover">
							<div class="product-cart">
								<a class="btn btn-secondary btn-block" href="single-product.php?&id=<?php echo $product->id;?>">Add To Cart</a>
							</div>
						</div>
					</div>
					<!-- .product-img end -->
					<div class="product-bio">
						...
						<p class="product-price">$<?php echo $product->p_price;?></p>
					</div>
					<!-- .product-bio end -->
